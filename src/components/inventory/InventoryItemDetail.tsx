...
const InventoryItemDetail: React.FC<InventoryItemDetailProps> = ({
  ...
  const item = {
    ...
    averageUsage: '2.5 kg/week',
    notes: 'Premium quality cheese, high demand item',
  ...
  const recentActivity = [
    ...
    { date: '2024-01-08', action: 'Order Placed', quantity: '10 kg', user: 'Jane Doe' }
  ];
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <Card>
              <CardContent className="p-6 text-center">
                ...
                <p className="text-2xl font-bold">{item.averageUsage}</p>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium text-gray-500">Primary Supplier</label>
                  <p className="font-medium">{item.supplier}</p>
                </div>
                <div>
                  <label className="text-sm font-medium text-gray-500">Last Ordered</label>
